    ...
    <View style={styles.container}>
          ...
          >
            <View style={[
              ...
              <Text style={styles.markerText}>
                {ICON_MAP[report.category_icon] || PIN_EMOJI}
              </Text>
            </View>
            <Callout tooltip>
                  ...
                  <View style={styles.calloutMeta}>
                    {report.address_suburb && (
                      <Text style={styles.calloutMetaText}>
                        {PIN_EMOJI} {report.address_suburb}
                      </Text>
                    )}
                    <Text style={styles.calloutMetaText}>
                      {CAL_EMOJI} {new Date(report.incident_date).toLocaleDateString('en-AU', {
      ...
      <TouchableOpacity style={styles.locateButton} onPress={handleLocateMe} activeOpacity={0.85}>
        {locating
          ...
          : <Text style={styles.locateIcon}>{CIRCLE_EMOJI}</Text>
        }
      </TouchableOpacity>
