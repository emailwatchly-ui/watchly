...
const SLIDES = [
  {
    ...
    title: 'Welcome to Watchly',
    subtitle: 'COMMUNITY CRIME AWARENESS',
    body: 'Help keep your community safe by reporting and tracking crime incidents in your area.',
  },
  {
    icon: String.fromCodePoint(0x1F5FA),
    title: 'Live Crime Map',
    subtitle: 'SEE WHAT\'S HAPPENING NEARBY',
    body: 'Browse an interactive map showing recent crime reports. Switch to heat map view to spot hotspot areas instantly.',
  },
  {
    icon: String.fromCodePoint(0x1F4CD),
    title: 'Report Incidents',
    subtitle: 'QUICK AND EASY REPORTING',
    body: 'Submit reports in seconds. Choose a category, describe what happened, and pin the location with optional privacy masking.',
  },
  {
    icon: String.fromCodePoint(0x1F512),
    title: 'Your Privacy Matters',
    subtitle: 'REPORT SAFELY',
    body: 'Enable location masking to offset your pin by ~75m. All reports are reviewed before appearing on the map.',
  },
]
...
const styles = StyleSheet.create({
  ...
  iconWrap: { width: 96, height: 96, borderRadius: 28, backgroundColor: COLORS.bgCard,
    borderWidth: 1, borderColor: '#2d3148', alignItems: 'center', justifyContent: 'center',
