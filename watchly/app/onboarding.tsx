...
const SLIDES = [
  ...
  { icon: "\uD83D\uDCCD", title: 'Share Incidents', subtitle: 'QUICK AND EASY SHAORTING', body: 'Submit reports in seconds. Choose a category, describe what happened, and pin the location with optional privacy masking.' },
